...
public class FreeCamera : CameraBase
{
    ...
    public float m_LookSpeedMousechild = 10.0f;
    ...
    protected override void Update()
    {
        ...
        {
            inputRotateAxisX = Input.GetAxis(kMouseX) * m_LookSpeedMousechild;
            inputRotateAxisY = Input.GetAxis(kMouseY) * m_LookSpeedMousechild;
        }
